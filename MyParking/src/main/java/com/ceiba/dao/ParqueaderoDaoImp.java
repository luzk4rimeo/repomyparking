...
//		String sql = "CREATE TABLE registro(id SERIAL, placa VARCHAR(255), cilindraje INTEGER(11), fechahoraingreso DATE, tipo VARCHAR(1))";
		String sql = "CREATE TABLE registro(id SERIAL, placa VARCHAR(255), cilindraje INTEGER(11), tipo VARCHAR(255))";
		jdbcTemplate.execute(sql);
	}
	@Override
//	public void ingresarVehiculo(String placa, Integer cilindraje, Date fechahoraingreso, String tipo) {
